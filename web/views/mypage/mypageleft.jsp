...
<div id="A_Container_L">
   ...
   <div class="left_menu">
         ...
         <dl>
               <a href="#"><dt>메세지</dt></a>
               <a href="/p/views/member/allmessage.jsp"><dd>전체 메세지</dd></a>
               <a href="/p/views/member/yetmessage.jsp"><dd>안읽은 메세지</dd></a>
               <a href="/p/views/member/importmessage.jsp"><dd>중요 메세지</dd></a>
         </dl>
   </div>
   </div>
