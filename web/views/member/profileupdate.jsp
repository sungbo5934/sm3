					...
					<table class="person_change" cellspacing="0">
						...
						<tbody>
							...
							<tr>
								...
								</select> <input type="hidden" name="strEmail"
									value="wntmd1215@naver.com"> <script
										language="javascript">
									<!--
							...
							<tr>
								...
								</select> - <input style="width: 80px;" type="text" maxlength="4"
									size="4" name="strMobil2" value=""
									onkeyup="if(isNaN(this.value))this.value='';SetHandPhone_strMobil(this.form);">
									- <input style="width: 80px;" type="text" maxlength="4"
									size="4" name="strMobil3" value=""
									onkeyup="if(isNaN(this.value))this.value='';SetHandPhone_strMobil(this.form);">
						...
						<table class="resumeTable" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<td class="send_check"><input name="bitNews"
										class="sns_send" type="radio" value="true"> <span>수신함</span>
										<input name="bitNews" class="sns_send" type="radio" checked=""
								...
								<tr>
									...
									<td class="send_check"><input name="bitNews2"
										class="sns_send" type="radio" value="True"> <span>수신함</span>
										<input name="bitNews2" class="sns_send" type="radio"
										checked="" value="False"> <span>수신안함</span></td>
								</tr>
							</tbody>
						</table>
					</div>
					<div class="btn_joinL">
						<a href="login.jsp"><span>수정하기</span></a> <input type="reset"
							value="취소하기">
					</div>
				</form>
			</div>
