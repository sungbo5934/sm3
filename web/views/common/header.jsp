...
<% ArrayList<HashMap<String, Object>> profilImg = (ArrayList<HashMap<String, Object>>)session.getAttribute("profilImg");%>
...
<body>
   ...
   <% if(loginUser == null){ %>
      <div class="w3-bar w3-white w3-wide w3-padding w3-card">
         <a href="/p/views/main/Realmain.jsp" class="w3-bar-item w3-button">Today's
            Colleague</a>
         <!-- Float links to the right. Hide them on small screens -->
         <div class="w3-right w3-hide-small">
            <a href="/p/views/member/login.jsp" class="w3-bar-item w3-button">Login</a>
            <a href="../member/join_step1.jsp" class="w3-bar-item w3-button" id="loginForm">Join</a>
         </div>
      </div>
      <%}else{ %>
      <div class="w3-bar w3-white w3-wide w3-padding w3-card">
         <a href="/p/views/main/Realmain.jsp" class="w3-bar-item w3-button">Today's Colleague</a>
         <!-- Float links to the right. Hide them on small screens -->
         <div class="w3-right w3-hide-small">
