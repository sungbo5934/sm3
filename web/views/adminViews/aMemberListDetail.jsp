...
<span></span>
<button class="tablink" onclick="openPage('About2', this, 'orange')">블랙때리기</button>
<span></span>

<div id="About1" class="tabcontent">
  <h3 style="text-align:center">신고내용</h3>
  <form>
  	<table class="table1">
  		<tr>
			<td>블랙여부</td>
  	...
  	<div align="center" style="margin-top:20px;">
		<button><a href="aMemberList.jsp">뒤로가기</a></button>
  	</div>
  </form>
</div>
...
window.onload = function(){
	openPage('About1', 'tablink', 'orange');
}
