...
<form name="frm" action="?gonguMode=form&amp;intSeq=&amp;" method="post">
   
   <ul class="register_cate">
      <li>
   <select name="cate1" class="select" onchange="document.frm.submit()">
      <option value="0">1차 카테고리 선택</option>
      
      <option value="1000000000">시간</option>
      
      <option value="1100000000">재능</option>
      
      <option value="1200000000">물건</option>
      
      <option value="1300000000">공간</option>
      
      <option value="1400000000">차량</option>
      ...
      <li>
   <select name="cate2" class="select" onchange="document.frm.submit()">
   ...
   <li>
   <select name="cate3" class="select" onchange="document.frm.submit()">
   ...
   <li>
   <select name="cate4" class="select" onchange="document.frm.submit()">
...
<form name="chkform" method="post" action="?intSeq=&amp;gonguMode=insert&amp;" enctype="multipart/form-data">
         ...
         <table class="person_change m_bottom40" cellspacing="0">
            <colgroup>
               ...
               <col>
                ...
                <tbody><tr>
               <th>재능명 *</th>
               <td><input class="max" type="text" name="g_title"></td>
            </tr>
            <tr>
               <th>지역선택</th>
               <td>
                  
         <select style="width:82px;" name="g_Place1">
            
            <option value="">도/광역시</option>
            <option value="서울특별시">서울특별시</option><option value="인천광역시">인천광역시</option><option value="대전광역시">대전광역시</option><option value="광주광역시">광주광역시</option><option value="대구광역시">대구광역시</option><option value="울산광역시">울산광역시</option><option value="부산광역시">부산광역시</option><option value="경기도">경기도</option><option value="강원도">강원도</option><option value="충청북도">충청북도</option><option value="충청남도">충청남도</option><option value="전라북도">전라북도</option><option value="전라남도">전라남도</option><option value="경상북도">경상북도</option><option value="경상남도">경상남도</option><option value="제주도">제주도</option>
         </select>
      
            <input type="text" name="g_Place2" class="w110px" placeholder="시/군/구">
            <input type="text" name="g_Place3" class="w150px" placeholder="동/읍/면">
               </td>
            </tr>
                <tr>
               <th>재능요청마감일 *</th>
               <td><input class="w400px datepicker hasDatepicker" type="text" name="g_date"  id="dp1519116021384"></td>
            </tr>
                <tr>
               <th>희망가격 *</th>
               <td><input class="w400px" type="text" name="g_customerMoney"> 원</td>
            </tr>
            <tr>
               <th>재능상세설명 *</th>
               <td><textarea class="max" name="g_Memo" placeholder="판매를 원하시는 분들은 공유요청이 아닌 공유등록 기능을 이용해주세요."></textarea></td>
            </tr>

         </tbody></table>

         <div class="btn_joinL">
            <a href="../views/common/tal1.jsp" onclick="chk(); return false;"><span>등록</span></a>
         </div>
</form>
